...
export const MessageResponses = () => {
    ...
    useEffect(() => {
        getResponsesByMessageId(messageId).then(messageResponseData => setResponses(messageResponseData));
    }, [messageId]);
    ...
    return (
        <>
            ...
            <Button onClick={() => navigate(`/messages/${messageId}/responses/create`)}>Add Response</Button>
        </>
    );
}